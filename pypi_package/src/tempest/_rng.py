...
class TempestRNG:
    ...
    def _init_state(self, key, nonce):
        ...
        """Use ctypes.Structure matching tempest_state (6 × uint64_t, no padding)"""
        class TempestCState(ctypes.Structure):
            _fields_ = [("u", ctypes.c_uint64), ("v", ctypes.c_uint64),
                        ("w", ctypes.c_uint64), ("z", ctypes.c_uint64),
                        ("r", ctypes.c_uint64), ("weyl", ctypes.c_uint64)]
        self._state = TempestCState()
        k_arr = (ctypes.c_uint64 * 4)(*key)
        n_arr = (ctypes.c_uint64 * 2)(*nonce)
        self._lib.tempest_init.argtypes = [ctypes.c_void_p, ctypes.POINTER(ctypes.c_uint64), ctypes.POINTER(ctypes.c_uint64)]
