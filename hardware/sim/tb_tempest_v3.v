...
module tb_tempest_v3;
    ...
    integer wi;
    initial begin
        exp[1] = 64'h6BBE30BB1D12DDD0;
        exp[2] = 64'hB9167FE6CCEC68D9;
        exp[3] = 64'hCF6F7BA5C6AED360;
        exp[4] = 64'hA53C77D6D081BEC3;
        exp[5] = 64'h7F5A13D9CBF1CD84;
    end
