...
def cuda_available():
    """Lazy check: returns True if CUDA is available (checked on first call)."""
    if not hasattr(cuda_available, "_result"):
        cuda_available._result = _check_cuda()
    return cuda_available._result
device_name = ""
